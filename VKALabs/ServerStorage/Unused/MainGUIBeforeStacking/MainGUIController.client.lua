...
--local hotbarTools2 = { {hotBar1Tool, 0}, {hotBar2Tool, 0}, {hotBar3Tool, 0}, {hotBar4Tool,0},
--		{hotBar5Tool, 0}, {hotBar6Tool, 0}, {hotBar7Tool, 0}, {hotBar8Tool, 0}, {hotBar9Tool,0} }
...
local function UnHighlightAllHotBar()
...
-- Hightlight Hotbar..
local function HightlightHotBar(tool)
	
	-- Unighlight all first..
	UnHighlightAllHotBar()
...
local function ActivateHotbar(hotbarNumber)
	...
	if toolThatsMoving then
		...
		if toolThatsMoving ~= hotbarTools[hotbarNumber] then
			...
			if toolThatsMoving == equippedTool then
				...
				-- Highlight it..
				hotbarButton.Border.Visible = true
	...
	elseif equippedTool ~= hotbarTools[hotbarNumber] and equippedTool ~= nil then -- Had Another Weapon..
		...
		-- Set Equipped Tool
		equippedTool = hotbarTools[hotbarNumber]
...
local function PopulateBag()
	...
	for i, tool in ipairs(playerTools) do
		...
		newImageButton.SelectionGained:Connect(function()
		...
		-- Selection Gained Event..
		newImageButton.SelectionLost:Connect(function()
			
			-- if slot options is open..
			if slotOptionsFrame.Visible == true then return end
